...
nz_height_left_join <- st_join(nz_height, nz) %>% 
  select(is = t50_fid, elevation, region = Name)
...
```{r}
# aggregate values for singles points in cycle_hire_join
...
```{r}
tmap_arrange(nz_map1, nz_map2, nrow = 1)
```
