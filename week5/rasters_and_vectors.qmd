...
elevation_masked <- elevation_final
elevation_masked[elevation_masked < 2000] <- NA


# Convert those values into polygons and then transform into a sf
...
bryce_small %>% 
  # Mapping colors to elevation values
  height_shade() %>%  
  # actuallly plotting the map
  plot_map() 
```
...
```{r}
# Seperate lines into trails, footpaths, and roads
